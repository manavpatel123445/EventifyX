...
export class AuthService {
  ...
  async sendForgotPasswordEmail(email) {
    ...
    if (!user) {
      // Return success messaging to avoid email enumeration security vulnerability
    ...
    // In production, trigger a BullMQ job or service send email
    // e.g., emailQueue.add('sendResetEmail', { email: user.email, token: resetToken });
