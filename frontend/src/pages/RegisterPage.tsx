      ...
      <div className="relative flex items-center justify-center p-6 min-h-screen overflow-hidden pt-32">
        ...
        >
          <TiltCard damping={20} stiffness={120}>
            <div className="grid grid-cols-1 lg:grid-cols-12 bg-white/70 dark:bg-slate-900/70 backdrop-blur-3xl border border-white/50 dark:border-slate-800 rounded-[2rem] md:rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden min-h-[750px]">
              ...
              <div className="lg:col-span-7 p-6 md:p-16 flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                   ...
                   <button 
                     type="submit" 
                     disabled={loading}
                     className="w-full h-16 md:h-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-[2.5rem] font-black text-lg md:text-xl uppercase tracking-[0.2em] shadow-2xl hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4 disabled:opacity-50"
                   >
