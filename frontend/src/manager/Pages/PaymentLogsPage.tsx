    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 p-6 space-y-8 overflow-x-auto">
        ...
        <div className="bg-white rounded-xl shadow p-6 mt-6">
          <h2 className="text-xl font-semibold mb-4">My Events Revenue & Sales Summary</h2>
          {loading ? (
            ...
            <div className="text-center py-8 text-gray-500">No sales data available for your events.</div>
          ) : (
            <div className="space-y-6">
              {/* Summary Cards */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="text-gray-600 text-sm font-medium">My Total Revenue</h3>
                    ...
                    {logs.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan={5} className="px-6 py-4 text-center text-gray-500">
                          No payment logs found for your events
                        </td>
                      </tr>
                    )}
                  </tbody>
